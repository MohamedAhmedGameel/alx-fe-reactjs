...
function UserProfile() {
  return (
    <div className="user-profile md:max-w-sm bg-gray-100 p-4 sm:p-4 sm:p-6 md:p-8 max-w-xs md:text-xl sm:max-w-sm md:max-w-md mx-auto my-10 rounded-lg shadow-lg">
      <img
